package org.pl.gateway.module.model.exceptions;

import lombok.ToString;

@ToString
public class RepositoryRestException extends Exception {
    ...
    public static final String REPOSITORY_GET_BY_USERNAME_EXCEPTION = "Object with given Username does not exists in the repository.";
    ...
    public RepositoryRestException(String message) {
        super(message);
    }
}
