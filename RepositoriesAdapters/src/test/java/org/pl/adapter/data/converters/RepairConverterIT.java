...
public class RepairConverterIT {
    ...
    void convertRepairFromDomainToEntModelTest() {
        ...
        assertEquals(repair.getClient().isArchive(), repairEnt.getClientEnt().isArchive());
        ...
        assertEquals(repair.getHardware().isArchive(), repairEnt.getHardwareEnt().isArchive());
    ...
    void convertRepairFromEntToDomainModelTest() {
        ...
        assertEquals(repairEnt.getClientEnt().isArchive(), repair.getClient().isArchive());
        ...
        assertEquals(repairEnt.getHardwareEnt().isArchive(), repair.getHardware().isArchive());
