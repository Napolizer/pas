...
import org.pl.repair.module.adapter.data.model.ConditionEnt;
import org.pl.repair.module.adapter.data.model.HardwareEnt;
import org.pl.repair.module.adapter.data.model.HardwareTypeEnt;
...
public class HardwareConverterIT {
    ...
    void convertHardwareFromDomainToEntModelTest() {
        ...
        assertEquals(hardware.getArchive(), hardwareEnt.isArchive());
    ...
    void convertHardwareFromEntToDomainModelTest() {
        ...
        assertEquals(hardwareEnt.isArchive(), hardware.getArchive());
