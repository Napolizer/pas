...
public class RepairConverterIT {
    ...
    void convertRepairFromDomainToEntModelTest() {
        ...
        assertEquals(repair.getArchive(), repairRest.getArchive());
        ...
        assertEquals(repair.getHardware().getArchive(), repairRest.getHardware().getArchive());
    ...
    void convertRepairFromEntToDomainModelTest() {
        ...
        assertEquals(repairEnt.getArchive(), repair.getArchive());
        ...
        assertEquals(repairEnt.getHardware().getArchive(), repair.getHardware().getArchive());
